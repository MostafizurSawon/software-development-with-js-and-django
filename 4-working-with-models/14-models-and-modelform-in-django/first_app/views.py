...
from . forms import ContactForm, StudentData, PasswordValidationProject, StudentForm2
from . import models
...
def about(request):
  if request.method == 'POST':
    ...
    return render(request, 'about.html', {'name': name, 'email': email, 'ratings': ratings})
  else:
