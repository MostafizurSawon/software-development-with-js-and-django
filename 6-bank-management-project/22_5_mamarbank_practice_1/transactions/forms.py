...
def check_bank_condition():
    bank_condition = BankCondition.objects.get()
    return bank_condition.bankrupt
...
class TransactionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.bank_condition = check_bank_condition()
...
class WithdrawForm(TransactionForm):
    ...
    def clean_amount(self):
        ...
        if self.bank_condition:
            raise forms.ValidationError(
                f'Warning, Bank is currently bankrupt!'
            )
...
class TransferMoneyForm(TransactionForm):
    ...
    def clean_account_no(self):
        ...
        try:
            other_user = UserBankAccount.objects.get(account_no=account_no)
