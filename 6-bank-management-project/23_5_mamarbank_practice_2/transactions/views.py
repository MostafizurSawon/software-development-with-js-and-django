...
from .models import BankCondition
...
class TransferMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        account = self.request.user.account
        other_account = UserBankAccount.objects.get(account_no=account_no)
        other_account.balance += amount
        account.balance -= amount
        account.save(update_fields=['balance'])
        other_account.save(update_fields=['balance'])
        ...
        send_transaction_email("Transfer Completed", other_account.user, amount, other_account.user.email,
                               "transactions/other_account_email.html", account.account_no)
